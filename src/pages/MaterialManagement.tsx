...
import { ArrowLeft, Upload, Film, Image, Music, X, ChevronDown, Check, Camera, Mic, FileText } from 'lucide-react';
import { MATERIAL_STATUS_CONFIG, REVIEW_STATUS_CONFIG, type MaterialStatus, type ReviewStatus } from '@/types';
